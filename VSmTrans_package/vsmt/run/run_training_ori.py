...
from vsmt.run.default_configuration import get_default_configuration
from nnunet.paths import default_plans_identifier
from nnunet.training.cascade_stuff.predict_next_stage import predict_next_stage
from vsmt.training.network_training.nnUNetTrainer import nnUNetTrainer
...
def main():
    ...
    parser.add_argument("-network_trainer", type=str, default='nnUNetTrainerV2_AMOS')
    ...
    parser.add_argument("-outpath", type=str, default='Trainer_vsmt', help='output path')
    ...
    #                                           search_in=(vsmt.__path__[0], "training", "network_training"), \
    #                                           base_module='vsmt.training.network_training')

    trainer_class = get_default_configuration(args.outpath, network, task, network_trainer, plans_identifier)

    print("aaaaa"*50)
    print(trainer_class)

    trainer = trainer_class(plans_file, fold, output_folder=output_folder_name, dataset_directory=dataset_directory, batch_dice=batch_dice, stage=stage, unpack_data=decompress_data,
