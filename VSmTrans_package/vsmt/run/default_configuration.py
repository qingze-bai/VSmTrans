...
def get_default_configuration(out_name, network, task, network_trainer, plans_identifier=default_plans_identifier,
    ...
    output_folder_name = join(network_training_output_dir, network, task, out_name+network_trainer + "__" + plans_identifier)
